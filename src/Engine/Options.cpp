...
// this should probably be any small screen touch-device, i don't know the defines for all of them so i'll cover android and IOS as i imagine they're more common
	...
	_info.push_back(OptionInfo("keyEnterpriseResourceManagement", &keyEnterpriseResourceManagement, SDLK_e, "STR_ENTERPRISE_RESOURCE_MANAGEMENT", "STR_OXCE"));
	_info.push_back(OptionInfo("keyExecutiveSummary", &keyExecutiveSummary, SDLK_s, "STR_EXECUTIVE_SUMMARY", "STR_OXCE"));
